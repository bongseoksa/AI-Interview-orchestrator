...
| **발화 300자 절단** | 속기록·트랜스크립트 충실도 저하 | 무절단 세션 캡처 여부 결정(D8), 기본은 절단본 + 원본 로그 점프 |
...
| D8 | 발화 무절단 캡처 | GM0에서 세션 JSONL에 무절단 병행 | 회의록·속기록 "가감 없이" 요구 충족. 파일 크기↑ vs 충실도↑ (02 §8-5, secretary §6) |
